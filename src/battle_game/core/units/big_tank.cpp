...
Tank_1::Tank_1(GameCore *game_core, uint32_t id, uint32_t player_id)
  ...
  if (!~tank_body_model_index) {
    auto mgr = AssetsManager::GetInstance();
    {
      ...
      tank_body_model_index = mgr->RegisterModel(
          {
              {{-r, r}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{-r, -r}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{r, r}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
              {{r, -1.0f}, {0.0f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}},
...
void Tank_1::TankMove(float move_speed, float rotate_angular_speed) {
...
bool Tank_1::IsHit(glm::vec2 position) const {
...
const char *Tank_1::UnitName() const {
  return "Big Tank";
}

const char *Tank_1::Author() const {
  return "Zhang Zhengyang";
}
}  // namespace battle_game::unit
